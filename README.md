...
- [Another Cheat Sheet](https://web.stanford.edu/group/csp/cs21/htmlcheatsheet.pdf)
...
- [Color Mixer Generator](https://colorffy.com/color-mixer?colors=a4a5c6-0629f9)
- [Grid-layout Generator](https://angrytools.com/css-grid/)
- [Grid Overview](https://grid.malven.co/)
...
- [More about Media Queries](https://medium.com/@hello.dilandp/media-queries-for-standard-devices-part-01-d8cfed8c1602)
- [Responsive Webdesign](https://be-responsive.de/code/#:~:text=Was%20sind%20Breakpoints%3F,800%2C%201024%20und%201280%20Pixel.)
- [Undraw Illustration free to use](https://undraw.co/illustrations)
- [Hero Patterns](https://heropatterns.com/)
- [Font Awesome](https://fontawesome.com/icons?d=gallery&q=close&m=free)
- [Hero Icons](https://heroicons.com/)
- [The noun project](https://thenounproject.com/)
- [Animation Snippets](https://loading.io/)
-

## JavaScript

- [Cheat Sheet](https://htmlcheatsheet.com/js/)
- [Unsplash API Doc](https://unsplash.com/documentation#location)
...
- [Design Patterns](https://www.patterns.dev/vanilla/static-import)
- [More Patterns Info](https://www.patterns.dev/)
- [DOM Manipulation](https://overapi.com/html-dom)

## Web

- [Cheat Sheet - learn the web](https://learntheweb.courses/topics/cheat-sheets-checklists/)

## Practice

- [Frontend Practice](https://www.frontendpractice.com/projects)
- [JavaScript](https://javascript30.com/)
- [Frontend Mentor](https://www.frontendmentor.io/learning-paths/getting-started-on-frontend-mentor-XJhRWRREZd)
- [CSS Battle](https://cssbattle.dev/)
- [Coding Projects](https://devchallenges.io/)
- [Work at tech](https://workat.tech/frontend-development/practice)
- [Frontend Coding Challegnes](https://www.frontendpro.dev/frontend-coding-challenges)
